...
canvas = Canvas(root, width=1400, height=320)
canvas.grid()
...
for a in range(23):
    if (a+1)%2 == 0:
        pass
    ovals.append([[canvas.create_oval(15+60*a, 10, 15+60*a+44, 54, fill = "#b36d1e", state = "normal", activefill = "black"),0]])
    for b in range(4):
        ovals[a].append([canvas.create_oval(15+60*a, 114+b*44, 15+60*a+44, 114+b*44+44, fill = "#b36d1e", state = "normal", activefill = "black"),0])
